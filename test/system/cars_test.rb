...
class CarsTest < ApplicationSystemTestCase
  ...
  test "should create car" do
    ...
    fill_in "Build type", with: @car.build_type
    fill_in "Color", with: @car.color
    fill_in "Description", with: @car.description
    fill_in "Eng capacity", with: @car.eng_capacity
    check "Four wd" if @car.four_wd
    fill_in "Make", with: @car.make
    fill_in "Model", with: @car.model
    fill_in "Seat capacity", with: @car.seat_capacity
    fill_in "Transmission", with: @car.transmission
    fill_in "Yom", with: @car.yom
    click_on "Create Car"
